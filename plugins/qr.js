...
if (Config.WORKTYPE == 'private') {
    ...
    newCommand(
        ...
        await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*Made By WhatsAlexa*', contextInfo: { forwardingScore: 49, isForwarded: true }, quoted: message.data});
