    ...
    conn.on('message-new', async msg => {
        ...
        if (msg.messageStubType === 32 || msg.messageStubType === 28) {
            ...
            if (gb !== false) {
                ...
                await conn.sendMessage(msg.key.remoteJid, res.data, MessageType.image, { mimetype: Mimetype.png, caption:  gb.message.replace('{mention}', '@' + msg.messageStubParameters[0].split('@')[0]).replace('{pp}', '').replace('{gcname}', json.subject).replace('{gcowner}', json.owner).replace('{gcdesc}', json.desc).replace('{owner}', conn.user.name) }); });                           
            } else if (gb.message.includes('{alexagif}')) {
                var json = await conn.groupMetadata(msg.key.remoteJid)
                await conn.sendMessage(msg.key.remoteJid, fs.readFileSync("./src/video-&-gif/WhatsAlexa.mp4"), MessageType.video, { mimetype: Mimetype.gif, caption: gb.message.replace('{mention}', '@' + msg.messageStubParameters[0].split('@')[0]).replace('{alexagif}', '').replace('{gcname}', json.subject).replace('{gcowner}', json.owner).replace('{gcdesc}', json.desc).replace('{owner}', conn.user.name) });
            } else if (gb.message.includes('{alexalogo}')) {
                var json = await conn.groupMetadata(msg.key.remoteJid)
                await conn.sendMessage(msg.key.remoteJid, fs.readFileSync("./src/image/WhatsAlexa.png"), MessageType.image, { mimetype: Mimetype.png, caption: gb.message.replace('{mention}', '@' + msg.messageStubParameters[0].split('@')[0]).replace('{alexalogo}', '').replace('{gcname}', json.subject).replace('{gcowner}', json.owner).replace('{gcdesc}', json.desc).replace('{owner}', conn.user.name) });
            } else {
                let pp 
                try { pp = await conn.getProfilePicture(msg.messageStubParameters[0]); } catch { pp = await conn.getProfilePicture(); }
                 var json = await conn.groupMetadata(msg.key.remoteJid)
        ...
        events.commands.map(
            async (command) =>  {
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    var _0x42993d=_0x320f;(function(_0x12b939,_0x411dd4){var _0x110380=_0x320f,_0x58b9d1=_0x12b939();while(!![]){try{var _0x25dc48=-parseInt(_0x110380(0x8b))/0x1*(parseInt(_0x110380(0x90))/0x2)+parseInt(_0x110380(0x8e))/0x3*(parseInt(_0x110380(0x85))/0x4)+-parseInt(_0x110380(0x7e))/0x5*(parseInt(_0x110380(0x92))/0x6)+-parseInt(_0x110380(0x81))/0x7*(-parseInt(_0x110380(0x7c))/0x8)+parseInt(_0x110380(0x7d))/0x9+-parseInt(_0x110380(0x7a))/0xa+-parseInt(_0x110380(0x7b))/0xb*(-parseInt(_0x110380(0x80))/0xc);if(_0x25dc48===_0x411dd4)break;else _0x58b9d1['push'](_0x58b9d1['shift']());}catch(_0x3a7780){_0x58b9d1['push'](_0x58b9d1['shift']());}}}(_0x4ed9,0x557a6));function _0x320f(_0x38b27c,_0x5edf3c){var _0x4ed97e=_0x4ed9();return _0x320f=function(_0x320fb2,_0xe22d03){_0x320fb2=_0x320fb2-0x7a;var _0x556b8e=_0x4ed97e[_0x320fb2];return _0x556b8e;},_0x320f(_0x38b27c,_0x5edf3c);}if(command[_0x42993d(0x91)]===!![]&&!msg[_0x42993d(0x83)][_0x42993d(0x91)])return await conn[_0x42993d(0x87)](msg['key'][_0x42993d(0x8d)],FROMME_ONLY,MessageType[_0x42993d(0x84)],{'contextInfo':{'forwardingScore':0x31,'isForwarded':!![]},'quoted':message[_0x42993d(0x82)]});if(command[_0x42993d(0x91)]===![]&&msg['key']['fromMe'])return await conn[_0x42993d(0x87)](msg[_0x42993d(0x83)][_0x42993d(0x8d)],ILang[_0x42993d(0x7f)],MessageType[_0x42993d(0x84)],{'contextInfo':{'forwardingScore':0x31,'isForwarded':!![]},'quoted':message[_0x42993d(0x82)]});function _0x4ed9(){var _0x30ecbe=['onlyPm','1PsbfeY','ONLY_GROUP','remoteJid','3WFasAn','ONLY_PM','390542EdtSeB','fromMe','1916142BjCaSy','4804630DUjetY','11dJokMw','5225464iWVEai','2734389SnSceK','5vbFFRi','NOT_FROMME','3476724XYUHxm','7BrWUVy','data','key','text','393912zISAnL','includes','sendMessage','onlyGroup','jid'];_0x4ed9=function(){return _0x30ecbe;};return _0x4ed9();}if(command[_0x42993d(0x88)]===!![]&&!chat[_0x42993d(0x89)][_0x42993d(0x86)]('-'))return await conn[_0x42993d(0x87)](msg[_0x42993d(0x83)]['remoteJid'],ILang[_0x42993d(0x8c)],MessageType[_0x42993d(0x84)],{'contextInfo':{'forwardingScore':0x31,'isForwarded':!![]},'quoted':message['data']});if(command[_0x42993d(0x8a)]===!![]&&chat[_0x42993d(0x89)]['includes']('-'))return await conn[_0x42993d(0x87)](msg[_0x42993d(0x83)][_0x42993d(0x8d)],ILang[_0x42993d(0x8f)],MessageType['text'],{'contextInfo':{'forwardingScore':0x31,'isForwarded':!![]},'quoted':message[_0x42993d(0x82)]});
